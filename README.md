...
>
> `deno run --allow-read --allow-write --unstable https://deno.land/x/deno_mongo_schema@v0.10.3/build/update.ts`
>
...
import {
  ...
  Schema,
  UpdateExOptions,
} from "https://deno.land/x/deno_mongo_schema@v0.10.3/mod.ts";
import type { Document } from "https://deno.land/x/deno_mongo_schema@v0.10.3/mod.ts";
