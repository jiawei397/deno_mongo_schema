...
>
> `deno run --allow-read --allow-write --unstable https://deno.land/x/deno_mongo_schema@v0.10.1/build/update.ts`
>
...
import {
  ...
  Schema,
  UpdateExOptions,
} from "https://deno.land/x/deno_mongo_schema@v0.10.1/mod.ts";
import type { Document } from "https://deno.land/x/deno_mongo_schema@v0.10.1/mod.ts";
