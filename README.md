...
>
> `deno run --allow-read --allow-write --unstable https://deno.land/x/deno_mongo_schema@v0.11.0/build/update.ts`
>
...
import {
  ...
  Schema,
  UpdateExOptions,
} from "https://deno.land/x/deno_mongo_schema@v0.11.0/mod.ts";
import type { Document } from "https://deno.land/x/deno_mongo_schema@v0.11.0/mod.ts";
